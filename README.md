...
| [@joaopedrojp2512](https://github.com/joaopedrojp2512) | Documentos & Integridade — `routers/documentos.py`, `routers/integridade.py`, `services/hash_service.py`, `config.py`, `config.yaml` |
